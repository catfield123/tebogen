...
class ChooseValidatorScreen(BaseScreen):
    """
    ...
    def fetch_validators(self, config_controller: ConfigController):
        ...
        The first item in the menu_items is always "[No validator]".
    ...
    def handle_input(self, key):
        ...
        if key == curses.KEY_BACKSPACE:
            ...
            if self.selected_idx == 0:
                ...
                self.callback(self.menu_items[self.selected_idx]())
                self.navigate_back()
